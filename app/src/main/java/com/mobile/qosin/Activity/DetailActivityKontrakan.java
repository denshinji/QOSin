...
public class DetailActivityKontrakan extends AppCompatActivity {
    ...
    private void getKontrakan() {
        ...
        String pk = intent.getStringExtra("iFav");
        if (pk.equals("FAV")) {
            Favorite kontrakan = intent.getParcelableExtra(FAV_KEY);
            jenis = kontrakan.getJenis();
            id = kontrakan.getId();
            gender = kontrakan.getGender();
